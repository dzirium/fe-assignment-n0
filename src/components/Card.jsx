...
export default function Card(id, perfumeRating, perfume) {
  return (
    <div className="m-2 flex w-full max-w-xs flex-col rounded-lg border border-gray-100 bg-white shadow-md  ">
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <div className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">View more</div>
      </div>
    </div>
  );
}
